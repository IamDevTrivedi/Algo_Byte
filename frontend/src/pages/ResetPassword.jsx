      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            Enter your emailId to reset password
          </p>
        </div>

        {/* Login Card with Squiggly Border */}
          ...
          <div className="relative z-10 bg-white dark:bg-black rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {called && (
                  <p className="text-green-600 dark:text-red-400 text-sm font-medium flex items-center gap-2">
