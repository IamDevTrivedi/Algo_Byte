  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        >
          <h2 className="text-3xl font-bold text-black dark:text-white mb-2">Problem Created Successfully!</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Your coding challenge has been added to the platform.</p>
          <button
            onClick={onClose}
    ...
    <div className="absolute inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-white/95 dark:bg-black/95 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-700 shadow-2xl p-6 max-w-md mx-4">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-black dark:text-white mb-2">Create Problem</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Are you ready to create this coding problem? This will add your challenge to the platform for others to
            solve.
          </p>
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-500 ${
                    isCompleted
                      ...
                      : isActive
                        ? "bg-black dark:bg-white border-black dark:border-black text-white dark:text-black shadow-lg"
                        : isAccessible
                          ? "bg-white dark:bg-black border-gray-300 dark:border-white text-gray-600 dark:text-white hover:border-gray-400 dark:hover:border-gray-500"
                          : "bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-white text-gray-400 dark:text-white"
                  }`}
                >
                  {isCompleted ? (
  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 w-80 max-h-[80vh] z-30">
      <div className="bg-white/95 dark:bg-black/95 backdrop-blur-xl rounded-xl border border-gray-200 dark:border-gray-700 shadow-2xl overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="text-center p-2 bg-gray-50 dark:bg-gray-900 rounded border border-gray-200 dark:border-white">
                  <div className="font-bold text-black dark:text-white">{formData.visibleTestCases?.length || 0}</div>
                  <div className="text-black dark:text-white">Visible Tests</div>
                </div>
                <div className="text-center p-2 bg-gray-50 dark:bg-gray-900 rounded border border-gray-200 dark:border-white">
                  <div className="font-bold text-black dark:text-white">{formData.hiddenTestCases?.length || 0}</div>
                  <div className="text-black  dark:text-white">Hidden Tests</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Preview Footer */}
        <div className="p-3 border-t border-gray-200 dark:border-white bg-gray-50/50 dark:bg-gray-900/50">
          <div className="flex items-center justify-center gap-2">
            <div className="w-2 h-2 bg-gray-500 rounded-full animate-pulse"></div>
            <span className="text-xs text-gray-600 dark:text-white font-medium">Live Preview Active</span>
          </div>
        </div>
      </div>
    </div>
...
export function CreateProblem() {
  ...
  const { displayText, isComplete, showCursor } = useTypewriter("Create New Problem", 80)
  ...
  return (
    <div className="relative min-h-screen  text-black dark:text-white transition-colors duration-300 isolate">
      ...
      >
        <FireParticles />
        <div className="relative z-10 bg-white/95 dark:bg-black/95 backdrop-blur-xl rounded-2xl border border-gray-300 dark:border-gray-700 shadow-2xl p-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Craft the next great challenge for our coding community.
            </p>
          </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Review your problem details and create the challenge.
                  </p>
                </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-green-800 dark:text-green-300">Ready to Create</h3>
                      <p className="text-sm text-green-600 dark:text-green-400">
                        All required fields have been completed. You can now create your problem.
                      </p>
                    </div>
                  </div>
                </div>
